...
public interface T123W<T, K extends Annotatable> {
    ...
    T123W<T, K> baseline(BaselineBuilder<T, K> builder) throws FlowBuilderException;
    ...
    interface BaselineBuilder<T, K extends Annotatable> {
        // BaselineBuilder<T, K> extractor(Extractor<O> extractor);

        // BaselineBuilder<T, K> digester(Digester<T, K> digester);
